function plot_error_with_stats(filenames, error_headers, dataTime)
    ...
    ylabel('Error (radian)', 'FontSize', 14);
...
% plot_error_with_stats('0paraNeuroIT2FS-.csv', {'e1','e2','e3'}, 17);

plot_error_with_stats('1000helixNeuroIT2FS-1.csv', {'ActualCurr1','ActualCurr2','ActualCurr3'}, 7);
plot_error_with_stats('1000helixNeuroMamdaniT1-1.csv', {'ActualCurr1','ActualCurr2','ActualCurr3'}, 7);
