function T = calculate_mean_std()
    % Daftar file CSV
    % files = { ...
    %     '0helixNeuroMamdaniT1-1.csv', '0helixNeuroMamdaniT1-2.csv', '0helixNeuroMamdaniT1-3.csv', ...
    %     '0helixNeuroMamdaniT1-4.csv', '0helixNeuroMamdaniT1-5.csv', '0helixNeuroMamdaniT1-6.csv', ...
    %     '0helixNeuroMamdaniT1-7.csv', '0helixNeuroMamdaniT1-8.csv', '0helixNeuroMamdaniT1-9.csv', ...
    %     '0helixNeuroMamdaniT1-10.csv'};

    % files = { ...
    %     '0helixNeuroIT2FS-1.csv', '0helixNeuroIT2FS-2.csv', '0helixNeuroIT2FS-3.csv', ...
    %     '0helixNeuroIT2FS-4.csv', '0helixNeuroIT2FS-5.csv', '0helixNeuroIT2FS-6.csv', ...
    %     '0helixNeuroIT2FS-7.csv', '0helixNeuroIT2FS-8.csv', '0helixNeuroIT2FS-9.csv', ...
    %     '0helixNeuroIT2FS-10.csv'};
    ...
    % files = { ...
    %     '0helixFuzzySynergeticT2-1.csv', '0helixFuzzySynergeticT2-2.csv', '0helixFuzzySynergeticT2-3.csv', ...
    %     '0helixFuzzySynergeticT2-4.csv', '0helixFuzzySynergeticT2-5.csv', '0helixFuzzySynergeticT2-6.csv', ...
    %     '0helixFuzzySynergeticT2-7.csv', '0helixFuzzySynergeticT2-8.csv', '0helixFuzzySynergeticT2-9.csv', ...
    %     '0helixFuzzySynergeticT2-10.csv'};
    ...
    %     '0helixFuzzySynergeticT1-10.csv'};
     ...
     % files = { ...
     %    '0helixSynergetic-1.csv', '0helixSynergetic-2.csv', '0helixSynergetic-3.csv', ...
     %    '0helixSynergetic-4.csv', '0helixSynergetic-5.csv', '0helixSynergetic-6.csv', ...
     %    '0helixSynergetic-7.csv', '0helixSynergetic-8.csv', '0helixSynergetic-9.csv', ...
     %    '0helixSynergetic-10.csv'};

   % files = { ...
   %  '0helixPID-1.csv', '0helixPID-2.csv', '0helixPID-3.csv', ...
   %  '0helixPID-4.csv', '0helixPID-5.csv', '0helixPID-6.csv', ...
   %  '0helixPID-7.csv', '0helixPID-8.csv', '0helixPID-9.csv', ...
   %  '0helixPID-10.csv'};

  % files = { ...
  %   '0helixFuzzyPIDT1-1.csv', '0helixFuzzyPIDT1-2.csv', '0helixFuzzyPIDT1-3.csv', ...
  %   '0helixFuzzyPIDT1-4.csv', '0helixFuzzyPIDT1-5.csv', '0helixFuzzyPIDT1-6.csv', ...
  %   '0helixFuzzyPIDT1-7.csv', '0helixFuzzyPIDT1-8.csv', '0helixFuzzyPIDT1-9.csv', ...
  %   '0helixFuzzyPIDT1-10.csv'};

    % files = { ...
    %     '0helixFuzzyPIDT2-1.csv', '0helixFuzzyPIDT2-2.csv', '0helixFuzzyPIDT2-3.csv', ...
    %     '0helixFuzzyPIDT2-4.csv', '0helixFuzzyPIDT2-5.csv', '0helixFuzzyPIDT2-6.csv', ...
    %     '0helixFuzzyPIDT2-7.csv', '0helixFuzzyPIDT2-8.csv', '0helixFuzzyPIDT2-9.csv', ...
    %     '0helixFuzzyPIDT2-10.csv'};

    % files = { ...
    %     '0helixSMC-1.csv', '0helixSMC-2.csv', '0helixSMC-3.csv', ...
    %     '0helixSMC-4.csv', '0helixSMC-5.csv', '0helixSMC-6.csv', ...
    %     '0helixSMC-7.csv', '0helixSMC-8.csv', '0helixSMC-9.csv', ...
    %     '0helixSMC-10.csv'};

    % files = { ...
    %     '0helixFuzzySMCT1-1.csv', '0helixFuzzySMCT1-2.csv', '0helixFuzzySMCT1-3.csv', ...
    %     '0helixFuzzySMCT1-4.csv', '0helixFuzzySMCT1-5.csv', '0helixFuzzySMCT1-6.csv', ...
    %     '0helixFuzzySMCT1-7.csv', '0helixFuzzySMCT1-8.csv', '0helixFuzzySMCT1-9.csv', ...
    %     '0helixFuzzySMCT1-10.csv'};

    % files = { ...
    %     '0helixFuzzySMCT2-1.csv', '0helixFuzzySMCT2-2.csv', '0helixFuzzySMCT2-3.csv', ...
    %     '0helixFuzzySMCT2-4.csv', '0helixFuzzySMCT2-5.csv', '0helixFuzzySMCT2-6.csv', ...
    %     '0helixFuzzySMCT2-7.csv', '0helixFuzzySMCT2-8.csv', '0helixFuzzySMCT2-9.csv', ...
    %     '0helixFuzzySMCT2-10.csv'};


    % files = { ...
    %     '0helixNeuroIT2FS-SIM-1.csv', '0helixNeuroIT2FS-SIM-2.csv', '1000helixNeuroIT2FS-SIM-3.csv', ...
    %     '1000helixNeuroIT2FS-SIM-4.csv', '1000helixNeuroIT2FS-SIM-5.csv', '1000helixNeuroIT2FS-SIM-6.csv', ...
    %     '1000helixNeuroIT2FS-SIM-7.csv', '1000helixNeuroIT2FS-SIM-8.csv', '1000helixNeuroIT2FS-SIM-9.csv', ...
    %     '1000helixNeuroIT2FS-SIM-10.csv'};

    files = {'500helixNeuroIT2FS-SIM.csv'};
