...
# [SMC] nama file diganti agar tidak menimpa data lain
csv_file = open(str(COLLECTED_DATA_DIR / "500helixSMC-10.csv"), 'w', newline='')
csv_writer = csv.writer(csv_file)
# [SMC] kolom mu1/mu2/mu3 -> eta1/eta2/eta3 (jumlah kolom tetap 31, struktur tak berubah)
...
# [SMC] Frame biner SMCnew_Rev.ino identik dengan versi Synergetic/PID:
    ...
    def read_from_arduino(self):
        ...
        while True:
            try:
                ...
                # ==========================================================
                # [SMC] Pengganti fuzzy/synergetic: GAIN SWITCHING eta STATIS.
                # SMCnew_Rev.ino mem-parse 3 angka pertama sebagai eta1,eta2,eta3
                # (switching gain reaching law). Default mengikuti firmware: 20.0.
                # Naikkan jika respon lambat; turunkan jika chattering / overshoot.
                # ==========================================================
                eta1 = 650.0
                eta2 = 650.0
                eta3 = 650.0
                ...
                if self.motor_state == 'IDLE' or self.motor_state == 'STANDBY':
                    ...
                    # [SMC] kirim eta1,eta2,eta3 (bukan mu)
...
if __name__ == "__main__":
    print("Program berjalan (mode SMC). Membaca data dari serial...")
