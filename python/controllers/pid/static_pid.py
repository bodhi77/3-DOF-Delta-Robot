...
# [REVISI PID] nama file diganti agar tidak menimpa data Synergetic
csv_file = open(str(COLLECTED_DATA_DIR / "500helixPID-10.csv"), 'w', newline='')
csv_writer = csv.writer(csv_file)
# [REVISI PID] kolom mu1/mu2/mu3 -> Kp/Ki/Kd (jumlah kolom tetap 31, struktur tak berubah)
...
# [REVISI PID] Frame biner PID_Rev.ino identik dengan versi Synergetic:
#   15 float = [posErr1,2,3, dEpos1,2,3, angle1,2,3_deg,
#               calcPidCurr1,2,3, measuredCurr1,2,3]
# jadi parser di bawah TIDAK perlu diubah.
HDR = b"\xAA\x55"
    ...
    def read_from_arduino(self):
        ...
        while True:
            try:
                ...
                # ==========================================================
                # [REVISI PID] Pengganti fuzzy/synergetic: GAIN PID STATIS.
                # PID_Rev.ino mem-parse 3 angka pertama sebagai Kp,Ki,Kd
                # (BUKAN mu). Default mengikuti firmware: 10.0, 0.1, 0.015.
                # ==========================================================
                Kp = 1050.0
                Ki = 10
                Kd = 0.015
                ...
                if self.motor_state == 'IDLE' or self.motor_state == 'STANDBY':
                    ...
                    # [REVISI PID] kirim Kp,Ki,Kd (bukan mu)
                    data_to_send = f"{Kp:.4f},{Ki:.4f},{Kd:.4f},{self.setangle1:.4f},{self.setangle2:.4f},{self.setangle3:.4f}\n"
...
if __name__ == "__main__":
    print("Program berjalan (mode PID). Membaca data dari serial...")
    ...
    try:
        while True:
            # Menu Kendali: S untuk Standby, R untuk Run, X untuk Stop
