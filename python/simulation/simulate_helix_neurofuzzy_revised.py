...
# Output CSV name follows the true payload (e.g. 0helix... / 1000helix...)
OUT_CSV = os.path.join(OUT_DIR, f"500helixNeuroIT2FS-SIM.csv")
...
def main():
    ...
    for step in range(n_steps):
        ...
        # mechanical plant: M_hat_p qdd + C_hat_p dq + tau_g_p = Kt*i
